module.exports = function (env) {
  ...
  const LOCAL_CONSTANTS = {
    ...
    MONGO_URI:"mongodb+srv://findoc_user:nQKMemhPm0N4maIJ@cluster0.kr4lh0f.mongodb.net/findoc_communication",
    NODE_ENV: "development",
    SERVICE_NAME: "Findost-COMMUNICATION-Service",
    200: "success",
    JWT_ADMIN_SECRET: "1234_admin_findost",
    JWT_authorizedPerson_SECRET: "1234_authorizedPerson_findost",
    TOKEN_EXPIRATION: "24h",
  ...
  const PREPROD_CONSTANTS = {
    PORT: 2275,
    MONGO_URI:"mongodb://devops:Dev$1234@findoc-preprod-docdb-2024-01-17-13-34-25.cluster-chi2e68wccik.ap-south-1.docdb.amazonaws.com:27017/findoc_communication?authMechanism=DEFAULT&tls=true&authSource=findoc_communication&retryWrites=False",
